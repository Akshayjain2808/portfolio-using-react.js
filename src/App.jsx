  ...
  return (
    <div className="font-[Poppins] scroll-smooth">
      ...
      <nav className="hidden md:flex justify-around items-center h-[17vh] ">
        <div className="text-4xl">Akshay Jain</div>
      ...
      <section id="profile" className="flex flex-col md:flex-row justify-center items-center top-20 h-[120vh] md:h-[84vh] gap-10 px-6 md:px-20">
        <div className=" relative">
          <img src="src/assets/akshayjain.png" alt="Profile" className="w-[25rem] h-[25rem] rounded-full object-cover" />
        </div>
        ...
        <div className="text-center md:text-left flex flex-col items-center gap-2">
          ...
          <h1 className="text-5xl font-bold">Akshay Jain</h1>
          ...
          <div className="flex justify-center md:justify-start gap-4">
            <img src="src/assets/linkedin.png" alt="LinkedIn" className="h-8 cursor-pointer" onClick={() => window.location.href='https://www.linkedin.com/in/Akshay-jain-797a28261/'} />
            <img src="src/assets/github.png" alt="Github" className="h-8 cursor-pointer" onClick={() => window.location.href='https://github.com/Akshayjain2808'} />
          </div>
        </div>
          ...
          {[1, 2, 3].map(num => (
            <div key={num} className="p-6 border rounded-2xl bg-gray-100 text-center">
              ...
              <div className="flex justify-center gap-4">
                <a href="https://github.com/Akshayjain2808/" className="border border-gray-600 px-4 py-1 rounded-full hover:bg-black hover:text-white">GitHub</a>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="contact" className="px-6 md:px-20 py-5">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-10 mt-10 border rounded-2xl p-6 bg-white w-1/2 mx-auto border-gray-600">
          <div className="flex items-center gap-4 ">
            ...
            <a href="mailto:jainakshay28082003@gmail.com" className="text-lg">Gmail</a>
          </div>
          <div className="flex items-center gap-4 ">
            <img src="src/assets/linkedin.png" alt="LinkedIn" className="h-6" />
            <a href="https://www.linkedin.com/in/Akshay-jain-797a28261/" className="text-lg">LinkedIn</a>
          </div>
        </div>
      </section>
